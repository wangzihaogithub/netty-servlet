...
public class MimeMappingsX implements Iterable<MimeMappingsX.MappingX> {
     ...
     */
    public static final MimeMappingsX DEFAULT;

    static {
        MimeMappingsX mappings = new MimeMappingsX();
    ...
    /**
     * Create a new {@link MimeMappingsX} instance from the specified mappings.
     * @param mappings the source mappings
     */
    public MimeMappingsX(MimeMappingsX mappings) {
        this(mappings, true);
    }

    /**
     * Create a new {@link MimeMappingsX} from the specified mappings.
     * @param mappings the source mappings with extension as the key and mime-type as the
     * value
     */
    public MimeMappingsX(Map<String, String> mappings) {
     ...
     */
    private MimeMappingsX(MimeMappingsX mappings, boolean mutable) {
        Objects.requireNonNull(mappings, "Mappings must not be null");
        this.map = (mutable
                ? new LinkedHashMap<String, MappingX>(mappings.map)
     ...
     */
    public static MimeMappingsX unmodifiableMappings(MimeMappingsX mappings) {
        return new MimeMappingsX(mappings, false);
    }
