...
import com.github.netty.servlet.util.SnowflakeIdWorker;
...
public class ServletHttpServletRequest implements javax.servlet.http.HttpServletRequest,Recyclable {
    ...
    public static ServletHttpServletRequest newInstance(HttpServletObject httpServletObject, FullHttpRequest fullHttpRequest) {
