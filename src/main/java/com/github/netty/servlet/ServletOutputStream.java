...
public class ServletOutputStream extends javax.servlet.ServletOutputStream implements Recyclable {
    ...
    public static ServletOutputStream newInstance(HttpServletObject httpServletObject) {
     ...
     */
    protected void setHttpServletObject(HttpServletObject httpServletObject) {
     ...
     * @return
     */
    protected HttpServletObject getHttpServletObject() {
