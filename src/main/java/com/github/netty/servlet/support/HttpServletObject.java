...
public class HttpServletObject implements Recyclable{
    ...
    public static HttpServletObject newInstance(ServletContext servletContext, NettyProperties config, ChannelHandlerContext context, FullHttpRequest fullHttpRequest) {
